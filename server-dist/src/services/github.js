export class GitHubService {
    RAW_URL = 'https://raw.githubusercontent.com/awesome-selfhosted/awesome-selfhosted/master/README.md';
    CACHE_KEY = 'awesome-selfhosted-data';
    CACHE_DURATION = 24 * 60 * 60 * 1000; // 24 hours in milliseconds
    async fetchAwesomeSelfHosted() {
        try {
            // Check cache first
