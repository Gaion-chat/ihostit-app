...
import type { ParsedCategory } from '../src/services/github.js';
...
export class ServerSyncService {
  ...
  async syncFromGitHub(): Promise<{ success: boolean; message: string; stats?: any }> {
    try {
      ...
      const githubData: ParsedCategory[] = await this.githubService.fetchAwesomeSelfHosted();
